...
const AudioPlayer = () => {
    ...
    return (
        <div className={styles.audioPlayer}>
            <audio ref={audioPlayer} src='/CHIARA - LA CANZONE NOSTRA.mp3' preload='metadata'> </audio>
            ...
            {/*progress bar*/}
            <div> 
                <input onChange={changeRange} ref={progressBar} type="range" className={styles.progressBar} defaultValue="0"/>
            </div>
